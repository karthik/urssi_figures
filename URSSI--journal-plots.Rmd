...
figure5 <- ggplot(dat, aes(x = Q1.1, fill = Q5.4)) +
    ...
    theme(axis.text.x = element_text(angle = 30, hjust = 1),
        plot.title = element_text(hjust = 0.5),
          legend.title = element_blank()) + ggtitle("Sufﬁcient Opportunities for Training")
figure5
ggsave(
...
figure6 <- ggplot(dat, aes(x = Q1.1, fill = Q5.5)) +
    ...
    theme(axis.text.x = element_text(angle = 30, hjust = 1),
        plot.title = element_text(hjust = 0.5),
          legend.title = element_blank()) + ggtitle("Sufﬁcient Time For Training")
figure6
ggsave(
...
figure8 <- ggplot(datmm, aes(x = Question, fill = Choice)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE)) + ggtitle("Sufﬁciency of Institutional Support")
figure8
ggsave(
...
figure11 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE))  + ggtitle("Concerns When Trying to Hire Software Development Staff")
figure11
ggsave(
...
figure14 <-
    ...
    theme(
        ...
        legend.title = element_blank(),
        legend.position = 'bottom'
    ) + ggtitle("How Authors Credit Software Used In Their Research")
...
figure15 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    theme(
        ...
        legend.title = element_blank(),
        legend.position = 'bottom'
    ) + ggtitle("How Respondents Currently Receive Credit For Their Software Contributions")
...
figure18 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    theme(
        ...
        plot.title = element_text(hjust = 0.5),
        legend.position = 'bottom'
    ) + ggtitle("How Respondents Think Their Project Does With Inclusion")
...
figure9 <- ggplot(dat, aes(x = Q14.2, fill = Q1.1)) +
    ...
    ) + ggtitle("Necessary Funding to Support Software Development Activities")
figure9
ggsave(
...
figure13 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE)) +
    ggtitle("Importance Of Factors When Taking A Job Or Promotion")
...
figure19 <- ggplot(dat, aes(x = Q17.1, fill = Q1.1)) +
    ...
    theme(
        ...
        plot.title = element_text(hjust = 0.5),
        legend.title = element_blank()
    ) +  ggtitle("Whether The Respondents’ Projects Have A Diversity/inclusion Statement")
figure19
ggsave(
...
figure20 <- ggplot(dat, aes(x = Q17.3, fill = Q1.1)) +
    ...
    theme(
        ...
        plot.title = element_text(hjust = 0.5),
        legend.title = element_blank()
    ) + ggtitle("Whether The Respondents’ Projects Have A Code Of Conduct")
figure20
ggsave(
...
figure21 <- ggplot(datmm, aes(x = Practice, fill = Q1.1)) +
    ...
    ) + ggtitle("Type Of Support Needed For Inclusion And Diversity")
