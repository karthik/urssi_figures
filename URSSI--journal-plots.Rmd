...
datmm = datm %>%
 ...
 #         Aspects = case_when(
 #             Aspects == "Project\nManagement" ~ "Proj Mgt",
 #             Aspects == "Requirements\nelicitation/engineering" ~ "Requirements",
 #         Aspects == "Finding personnel/\nDeveloper turnover" ~ "Personnel",
 #         Aspects == "Communication" ~ "Communication",
 #         Aspects == "Use of best practices vs.\nneed for rapid delivery" ~ "Best Practices",
 #         Aspects == "Keeping up with\nmodern tools" ~ "Modern Tools",
 #         Aspects == "Porting" ~ "Porting",
 #         Aspects == "Testing" ~ "Testing",
 #         Aspects == "Debugging" ~ "Debugging",
 #         Aspects == "Other" ~ "Other",
 #         Aspects == "None" ~ "None"))
 # 
