...
figure1 <- datm %>%
    ...
    labs(
        title = str_wrap(
            "Figure 1: Are Respondents Spending More Time On Tasks Than They Would Like Ideally?",
            70
        ),
        y = "Percent of time"
    )
...
figure2 <- ggplot(datmm, aes(x = Aspects, fill = Q1.1)) +
    ...
    theme(
        ...
        plot.title = element_text(hjust = 0.5),
        legend.title = element_blank() 
    ) + ggtitle("Aspects of software development that are more difﬁcult than they should be")
...
figure3 <- ggplot(datmm, aes(x = Question, fill = Choice)) +
    ...
    theme(axis.text.x = element_text(angle = 35, hjust = 1),
        plot.title = element_text(hjust = 0.5),
          legend.title = element_blank()) + ggtitle("Figure 3: Use of Testing")
figure3
ggsave(
...
figure4 <- ggplot(datmm, aes(x = Question, fill = Choice)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE)) + ggtitle("Figure 4: Availability of Tool Support")
figure4
ggsave(
...
figure5 <- ggplot(dat, aes(x = Q1.1, fill = Q5.4)) +
    ...
    theme(axis.text.x = element_text(angle = 30, hjust = 1),
        plot.title = element_text(hjust = 0.5),
          legend.title = element_blank()) + ggtitle("Figure 5: Sufﬁcient Opportunities for Training")
figure5
ggsave(
...
figure6 <- ggplot(dat, aes(x = Q1.1, fill = Q5.5)) +
    ...
    theme(axis.text.x = element_text(angle = 30, hjust = 1),
        plot.title = element_text(hjust = 0.5),
          legend.title = element_blank()) + ggtitle("Figure 6: Sufﬁcient Time For Training")
figure6
ggsave(
...
figure7 <- ggplot(datm, aes(x = Source, fill = Q1.1, y = Choice)) +
    ...
    ) + ggtitle("Figure 7: Sources of Funding")
figure7
ggsave(
...
figure8 <- ggplot(datmm, aes(x = Question, fill = Choice)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE)) + ggtitle("Figure 8: Sufﬁciency of Institutional Support")
figure8
ggsave(
...
figure10 <-
    ...
    ggtitle("Figure 10: Opportunities For Career Advancement for Software Developers")
figure10
ggsave(
...
figure11 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE))  + ggtitle("Figure 11: Concerns When Trying to Hire Software Development Staff")
figure11
ggsave(
...
figure12 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    ggtitle("Figure 12: Concerns When Being Hired As Software Development Staff")
figure12
ggsave(
...
figure14 <-
    ...
    theme(
        ...
        legend.title = element_blank(),
        legend.position = 'bottom'
    ) + ggtitle("Figure 14: How Authors Credit Software Used In Their Research")
...
figure15 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    theme(
        ...
        legend.title = element_blank(),
        legend.position = 'bottom'
    ) + ggtitle("Figure 15: How Respondents Currently Receive Credit For Their Software Contributions")
...
figure16 <- ggplot(dat, aes(x = Q1.1, fill = Q8.4)) +
    ...
    ggtitle("Figure 16: Does Institution Consider Software Contributions In Performance Reviews Or Promotion Cases")
figure16
ggsave(
...
figure17 <- ggplot(dat, aes(x = Q1.1, fill = Q8.5)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE)) +
    ggtitle("Figure 17: Importance Of Software Contributions During Performance Review Or Promotion")
figure17
ggsave(
...
figure18 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    theme(
        ...
        plot.title = element_text(hjust = 0.5),
        legend.position = 'bottom'
    ) + ggtitle("Figure 18: How Respondents Think Their Project Does With Inclusion")
...
figure9 <- ggplot(dat, aes(x = Q14.2, fill = Q1.1)) +
    ...
    ) + ggtitle("Figure 9: Necessary Funding to Support Software Development Activities")
figure9
ggsave(
...
figure13 <- ggplot(datmm, aes(x = Q1.1, fill = Choice)) +
    ...
    guides(fill = guide_legend(nrow = 2, byrow = TRUE)) +
    ggtitle("Figure 13: Importance Of Factors When Taking A Job Or Promotion")
...
figure19 <- ggplot(dat, aes(x = Q17.1, fill = Q1.1)) +
    ...
    theme(
        ...
        plot.title = element_text(hjust = 0.5),
        legend.title = element_blank()
    ) +  ggtitle("Figure 19: Whether The Respondents’ Projects Have A Diversity/inclusion Statement")
figure19
ggsave(
...
figure20 <- ggplot(dat, aes(x = Q17.3, fill = Q1.1)) +
    ...
    theme(
        ...
        plot.title = element_text(hjust = 0.5),
        legend.title = element_blank()
    ) + ggtitle("Figure 20: Whether The Respondents’ Projects Have A Code Of Conduct")
figure20
ggsave(
...
figure21 <- ggplot(datmm, aes(x = Practice, fill = Q1.1)) +
    ...
    ) + ggtitle("Figure 21: Type Of Support Needed For Inclusion And Diversity")
