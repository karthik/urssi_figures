...
ggthemr_reset()
# my_colors <- c("#001219", "#003540", "#005f73","#0a9396","#94d2bd","#e9d8a6","#ee9b00","#ca6702","#bb3e03","#ae2012","#9b2226")

wes_col <- c("#3B9AB2", "#E8C520","#EA5C00","#56A6BA","#71B3C2","#9EBE91","#D1C74C","#E4B80E","#E29E00","#F21A00")

urssi_colors <- define_palette(
 swatch = wes_col, # colours for plotting points and bars
 gradient = c(lower = wes_col[1L], upper = wes_col[2L]), #upper and lower colours for continuous colours
...
```{r Q2_4_details, echo = F, message = F, cache=TRUE}
...
datmm = datm %>%
    filter(!is.na(Choice))  %>% filter(Question != "Other")  
